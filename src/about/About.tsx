...
const About = () => {
  return (
    ...
    //         <div className='hidden lg:flex items-center justify-center h-max bg-gradient-to-br from-transparent via-blue-950 to-transparent rounded-2xl border-2 border-gray-800 '>
    //           <img
    //             src={Hero}
    //             alt=''
