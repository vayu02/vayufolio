...
const Experience = () => {
  const [exitsShowModal, setExitsShowModal] = useState(false);
  const [pangaShowModal, setPangaShowModal] = useState(false);
  const [novaShowModal, setNovaShowModal] = useState(false);

  const accomplismentExits = [
    {
      id: 1,
      task: "EV Charging Dashboards - Developed electric vehicle charging station dashboards with status monitoring, analytics, billing systems, user authentication, and reservation features, boosting infrastructure efficiency.",
    },
    {
      id: 2,
      task: "E-Commerce Applications - Built and managed e-commerce platforms with React.js, including product listings, shopping carts, order management, search/filter options, and wishlist features.",
    },
    {
      id: 3,
      task: "Secure File Rendering App -Engineered a secure file rendering application with JWT authentication, GPU/CPU utilization tracking, interactive charts, and a user-friendly file manager UI.",
    },
    {
      id: 4,
      task: "Managed multiple projects simultaneously, showcasing strong project management skills. Ensured alignment of project goals with client expectations through effective communication in stakeholder meetings and requirement gathering sessions.",
    },
    {
      id: 5,
      task: "Streamlined testing and deployment processes tailored to project requirements and client preferences, using platforms like Netlify, Vercel, Render, GoDaddy, and WinSCP for Apache servers.",
    },
  ];

  const accomplismentPanga = [
    {
      id: 1,
      task: "Developed pixel-perfect screens from Figma designs and integrated backend APIs for a seamless user experience.",
    },
    {
      id: 2,
      task: "Enhanced Reels UI with smooth animations using React Native Reanimated.",
    },
    {
      id: 3,
      task: "Used FFmpeg to trim, merge, and compress videos locally, enabling lightweight short-form content editing.",
    },
    {
      id: 4,
      task: "Maintained UI consistency and optimized performance across devices",
    },
  ];

  const accomplismentNovaTekno = [
    {
      id: 1,
      task: "Led React Native app with multiple flavors and device storage detection. Implemented PDF report generation and improved app stability using React Native Testing Library and MobX.",
    },
    {
      id: 2,
      task: "Architected real-time medical dashboard with D3.js (heatmaps, time-series graphs). Set up TypeScript + Vite web app with ESLint, Prettier, and Husky. Refactored codebase into reusable modules to reduce tech debt.",
    },
    {
      id: 3,
      task: " Migrated app from React Native to PWA for cross-device support. Ported AES-CBC/SHA-256 Python logic to Web Crypto API for secure device communication. Designed hybrid Bluetooth architecture using Web Bluetooth API, later transitioned to a FastAPI-based local server for iOS support.",
    },
  ];
  ...
  const AccomplishmentModal = ({
    ...
    isOpen: boolean;
    onClose: () => void;
    accomplishments: { id: number; task: string }[];
  }) => {
        ...
        <div className="modal-container bg-blue-950 w-11/12 md:max-w-md lg:max-w-lg mx-auto rounded shadow-lg z-50 overflow-y-auto">
          <div className="modal-content py-4 text-left px-6 text-white rounded-lg">
            ...
            <ul className="list-disc ml-6 text-white text-xs space-y-4">
              {accomplishments.map((item: { id: number; task: string }) => (
  ...
  return (
    <div className="px-6 py-6 w-[100vw]">
      <div className="  lg:flex gap-x-4">
        <div className="flex-1">
            ...
            <div className="flex flex-col gap-4 w-full md:flex-row">
              ...
              <article className="w-full">
                ...
                <div className="flex flex-col md:flex-row md:justify-between">
                  <div
                    className="text-[#eb4a4c] text-md font-medium cursor-pointer underline underline-offset-4"
                    onClick={() => setNovaShowModal(!novaShowModal)}
                  >
                    NovaTekno Systems
                  </div>
                  <div className="text-[#ccc] text-[14px] mt-2 md:mt-0">
                    MARCH 2020 - JUN 2023 | (3 yr 2mos)
                  </div>
                </div>
              </article>
            </div>
            ...
            <div className="flex flex-col gap-4 w-full md:flex-row">
              ...
              <article className="w-full">
                ...
                <div className="flex flex-col md:flex-row md:justify-between">
                  <div
                    className="text-[#eb4a4c] text-md font-medium cursor-pointer underline underline-offset-4"
                    onClick={() => setPangaShowModal(!pangaShowModal)}
                  >
                    Panga Productions
                  </div>
                  <div className="text-[#ccc] text-[14px] mt-2 md:mt-0">
            ...
            <div className="flex flex-col gap-4 w-full md:flex-row">
              ...
              <article className="w-full">
                ...
                <div className="flex flex-col md:flex-row md:justify-between">
                  <div
                    className="text-[#eb4a4c] text-md font-medium cursor-pointer underline underline-offset-4"
                    onClick={() => setExitsShowModal(!exitsShowModal)}
                  >
                    Exits Consultancy
                  </div>
                  <div className="text-[#ccc] text-[14px] mt-2 md:mt-0">
          ...
          <div className="mt-4 text-[#ccc] rounded bg-gradient-to-br from-transparent via-blue-950 to-transparent p-4 text-[14.5px] leading-relaxed">
            ...
            <p>
              I'm a versatile software engineer with a strong foundation in the
              MERN stack, TypeScript, and React Native. I’ve built impactful
              solutions across e-commerce, matrimonial apps, charging
              dashboards, and medical analyzers— blending frontend finesse with
              backend strength. My work spans offline-first mobile apps,
              real-time dashboards, PWA + Bluetooth IoT integrations, and
              performance tooling with WebGPU + Web Workers. I’m passionate
              about clean UX, robust architecture, and shipping fast, reliable
              features. Curious by nature, I also explore testing, DevOps,
              encryption, and even creative hardware ideas. Let’s build
      ...
      <AccomplishmentModal
        isOpen={exitsShowModal}
        onClose={() => setExitsShowModal(false)}
        accomplishments={accomplismentExits}
      />

      <AccomplishmentModal
        isOpen={pangaShowModal}
        onClose={() => setPangaShowModal(false)}
        accomplishments={accomplismentPanga}
      />

      <AccomplishmentModal
        isOpen={novaShowModal}
        onClose={() => setNovaShowModal(false)}
        accomplishments={accomplismentNovaTekno}
      />
    </div>
  );
};
